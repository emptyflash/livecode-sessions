...
func model n off =
    ...
    let
        ...
        aa ( x, y ) =
            { point = vec2 x y, n = n * 50 }
    in
    aa ( a * tan t, cos t ^ 2 - 1 )
...
vertexShader =
    [glsl|
        ...
        void main () {
            gl_PointSize = 50.0 * abs(sin(time / 1000.0));
...
fragmentShader =
    [glsl|
        ...
        void main() {
            vec3 color = hsb2rgb(vec3(fmod(hue / 50.0, 1.0), 1.0, 0.5));
